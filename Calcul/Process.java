...
public class Process {
	...
	public double getAvg(double total_old, double avg_old, double total_now, double avg_now) {
		
		double avg = 0;
		
		avg = ( ((total_old * avg_old) + (total_now * avg_now)) / (total_old + total_now) );
		
		avg = decimalScale(Double.toString(avg), 2, 2);
